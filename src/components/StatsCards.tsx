...
import { DashboardStats } from '@/types/fir';
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.totalPoliceStations}</div>
          <p className="text-xs text-muted-foreground">
            Active stations
          </p>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-lg font-bold capitalize">{stats.mostCommonIncidentType}</div>
          <p className="text-xs text-muted-foreground">
            Incident type
          </p>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent>
          <div className="text-2xl font-bold">{stats.averageDistanceFromPS} km</div>
          <p className="text-xs text-muted-foreground">
            From police station
          </p>
        </CardContent>
